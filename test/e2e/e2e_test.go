...
import (
	...
	"github.com/maksimstankevic/ekswatch-operator/test/utils"
)

const namespace = "ekswatch-operator-system"
...
var _ = Describe("controller", Ordered, func() {
	...
	Context("Operator", func() {
		It("should run successfully", func() {
			...
			var projectimage = "localhost:5001/ekswatch-operator:v0.0.1"
